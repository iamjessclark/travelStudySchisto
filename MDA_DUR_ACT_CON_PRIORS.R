...
#Prevalence ####
#
priors<-get_custom_prior_con("bernoulli")
...
priors<-get_custom_prior_con("gamma")
...
#This was the only one that the conservative priors made a difference on, so lets do normal 0,5 now

Act_mean_sm_five <- brm(mean_sm ~ ActNEW+ age_class+Location+Sex_bin+travel_frequency,
                   data=filt,
                   family="gamma",
...
ggsave("Figures/posterior_plot_con_prior.png", posterior_plot, width = 8, height = 12, dpi = 300)
ggsave("Figures/duration_plot_con_prior.png", duration_plot, width = 5, height = 2, dpi = 300)
...
ggsave("Figures/trace_plot_posts_con_prior.png", trace_plot, width = 8, height = 12, dpi = 300)
...
ggsave("Figures/duration_trace_con_prior.png", duration_trace, height = 2, width = 4, dpi = 300)
...
posterior_plot_sm
ggsave("Figures/posterior_plot_eggcount2_con_prior.png", posterior_plot_sm, width = 8, height = 12, dpi = 300)
...
ggsave("Figures/duration_plot_eggcount2_con_prior.png", duration_plot_sm, width = 4, height = 2, dpi = 300)
...
trace_plot_sm
ggsave("Figures/trace_plot_eggcount2_con_prior.png", trace_plot_sm, width = 8, height = 12, dpi = 300)
...
ggsave("Figures/duration_trace_eggcount2_con_prior.png", duration_trace_sm, height = 2, width = 4, dpi = 300)
...
# Activity (egg count)
activity_sm_draws <- Act_mean_sm_five %>%
  spread_draws(b_ActNEWDomestic,
               b_ActNEWOccupation,
               b_ActNEWRecreation,
               b_ActNEWTradeORVisit) %>%
...
posterior_plot_sm
ggsave("Figures/posterior_plot_eggcount2_mid_prior.png", posterior_plot_sm, width = 8, height = 12, dpi = 300)

#sensitivity analysis of frequency and infection models with conservative priors
...
#intercept mean of response and varaince of response
...
Freq_inf_mean <- brm(mean_sm~ travel_frequency+age_class+Sex_bin+Location,
                     ...
                     family="gamma",
                     prior= priors,
                     # Shape prior favours overdispersion, weakly regularising
                     iter = 10000, warmup = 3000, chains = 4, cores = 8,
                     control = list(max_treedepth = 15))
...
ggsave("Figures/trace_freq_inf_tot_con_priors.png", width = 4, height = 12, dpi = 300)
...
plot_posterior_distributions(
  ...
  output_file = "Figures/test/post_dist_freq_inf_tot_con_priors.png",
...
plot_trace(
  ...
  param_prefix = "travel_frequency",
  levels_order = levels_order,
  output_file = "Figures/test/trace_freq_inf_tot_con_priors.png"
)
...
plot_posterior_distributions(
  ...
  levels_order = levels_order,
  label_title = "Days travelled to the lake\nin the last 3 months",
  output_file = "Figures/test/post_dist_freq_inf_dir_con_priors.png",
  xlab = "Effect on log-odds of infection"
)
...
plot_trace(
  ...
  param_prefix = "travel_frequency",
  levels_order = levels_order,
  output_file = "Figures/test/trace_freq_inf_dir_con_priors.png"
)
...
plot_posterior_distributions(
  ...
  levels_order = levels_order,
  label_title = "Days travelled to the lake\nin the last 3 months",
  output_file = "Figures/test/post_dist_freq_epg_tot_con_priors.png",
...
plot_trace(
  ...
  param_prefix = "travel_frequency",
  levels_order = levels_order,
  output_file = "Figures/test/trace_freq_epg_tot_con_priors.png"
)
...
plot_posterior_distributions(
  ...
  levels_order = levels_order,
  label_title = "Days travelled to the lake\nin the last 3 months",
  output_file = "Figures/test/post_dist_freq_epg_dir_con_priors.png",
  xlab = "Effect on log mean eggs per gram"
)
...
plot_trace(
  ...
  param_prefix = "travel_frequency",
  levels_order = levels_order,
  output_file = "Figures/test/trace_freq_epg_dir_con_priors.png"
)
